...
<div class="row">
    <div class="col-md-12">
        <h1>Мои RSS-ленты
            <small><a class="refresh" onclick="RefreshRss();return false;" href="#"><i
                        class="glyphicon glyphicon-refresh"></i></a></small>
        </h1>
    </div>
</div>
<?php
        ...
        <div class="alert alert-warning" role="alert">
            <form id="filter" class="col-md-12 filter-main" action="" method="post">
                ...
                <div class="form-line col-md-2">
                    <button type="submit" name="date" value="<?php echo $date_sort ?>"
                            onclick="SortDate('<?php echo $date_sort ?>');return false;"
                            class="date-f <?php echo $date_button ?>"><span>Дате <i
                                class="<?php echo $date_glif ?>"></i></span></button>
                </div>
                <div class="form-line col-md-3">
                    <button type="submit" name="read" value="<?php echo $read_sort ?>"
                            onclick="SortRead('<?php echo $read_sort ?>');return false;"
                            class="read-f <?php echo $read_button ?>">Скрыть прочитанные
                    </button>
                </div>
                <div class="form-line col-md-2">
                ...
                <div class="form-line col-md-3">
                    <button type="submit" name="readen-all" value="<?php echo $_USER->getProperty("id") ?>"
                            onclick="ReadAllRss('<?php echo $_USER->getProperty("id") ?>');return false;"
                            class="btn btn-primary">Отметить все как прочитанное
                    </button>
                </div>
            </form>
