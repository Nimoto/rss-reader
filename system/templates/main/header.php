	      ...
	      <div class="container">
	        ...
	        <div id="navbar" class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	          	...
	          	?>
	            <li class="<?php if($url == '/'){echo 'active';}?>"><a href="#" onclick="OpenLink(this, '/'); return false;">Главная</a></li>
	            <?php if(!$_USER){?>
	            <li class="<?php if($url == '/register/'){echo 'active';}?>"><a href="/register/">Регистрация</a></li>
	            <?php }else{?>
	            <li class="<?php if($url == '/personal/'){echo 'active';}?>"><a href="#" onclick="OpenLink(this, '/personal/'); return false;">Личный кабинет</a></li>
	            <?php }?>
	          </ul>
	        </div><!--/.nav-collapse -->
	      </div>
